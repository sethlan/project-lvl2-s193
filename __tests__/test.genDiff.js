...
test('gendiff for recursive JSON in plain format', () => {
...
test('gendiff for recursive JSON in json format ', () => {
  expect(`${gendiff('__tests__/__fixtures__/beforeComp.json', '__tests__/__fixtures__/afterComp.json', 'json')}\n`)
    .toBe(fs.readFileSync('__tests__/__fixtures__/result8', 'utf-8'));
});
