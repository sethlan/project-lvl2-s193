...
const pathYamlComp1 = '__tests__/__fixtures__/beforeComp.yml';
const pathYamlComp2 = '__tests__/__fixtures__/afterComp.yml';
const pathIniComp1 = '__tests__/__fixtures__/beforeComp.ini';
const pathIniComp2 = '__tests__/__fixtures__/afterComp.ini';
...
const resultYmlComp = fs.readFileSync('__tests__/__fixtures__/result5', 'utf-8');
const resultIniComp = fs.readFileSync('__tests__/__fixtures__/result6', 'utf-8');
...
test('gendiff for recursive YAML', () => {
  expect(`${gendiff(pathYamlComp1, pathYamlComp2)}\n`)
    .toBe(resultYmlComp);
});
test('gendiff for recursive INI', () => {
  expect(`${gendiff(pathIniComp1, pathIniComp2)}\n`)
    .toBe(resultIniComp);
});
